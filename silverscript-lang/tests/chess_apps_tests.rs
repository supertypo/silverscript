...
fn size_snapshots() -> Vec<SizeSnapshot> {
    vec![
        ...
        SizeSnapshot {
            ...
            expected_bytecode_len: 2507,
            expected_sigscript_len: 6927,
            expected_instruction_count: 1818,
            expected_charged_op_count: 1208,
        },
        SizeSnapshot {
            name: "chess_mux.sil",
        ...
        SizeSnapshot {
            ...
            expected_sigscript_len: 7783,
            expected_instruction_count: 1600,
            expected_charged_op_count: 1042,
        },
        SizeSnapshot {
            name: "chess_pawn.sil",
