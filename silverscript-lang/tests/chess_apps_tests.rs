...
fn size_snapshots() -> Vec<SizeSnapshot> {
    vec![
        ...
        SizeSnapshot {
            ...
            expected_bytecode_len: 2823,
            expected_sigscript_len: 7559,
            expected_instruction_count: 2016,
            expected_charged_op_count: 1316,
        },
        SizeSnapshot {
            name: "chess_mux.sil",
            ...
            expected_charged_op_count: 817,
        },
        SizeSnapshot {
            name: "chess_settle.sil",
            ctor: settle_constructor_args,
            expected_bytecode_len: 2356,
            expected_sigscript_len: 8686,
            expected_instruction_count: 1766,
            expected_charged_op_count: 1130,
        },
        SizeSnapshot {
            name: "chess_pawn.sil",
        ...
        SizeSnapshot {
            ...
            expected_instruction_count: 947,
            expected_charged_op_count: 631,
        },
        SizeSnapshot {
            name: "chess_vert.sil",
            ctor: pawn_constructor_args,
            ...
            expected_instruction_count: 1463,
            expected_charged_op_count: 1010,
        },
        SizeSnapshot {
            ...
            expected_instruction_count: 1462,
            expected_charged_op_count: 1010,
        },
        SizeSnapshot {
            name: "chess_diag.sil",
        ...
        SizeSnapshot {
            ...
            expected_instruction_count: 1022,
            expected_charged_op_count: 672,
        },
        SizeSnapshot {
            ...
            expected_instruction_count: 1127,
            expected_charged_op_count: 742,
        },
    ]
}
