...
fn size_snapshots() -> Vec<SizeSnapshot> {
    vec![
        ...
        SizeSnapshot {
            ...
            expected_bytecode_len: 3116,
            expected_sigscript_len: 8145,
            expected_instruction_count: 2223,
            expected_charged_op_count: 1454,
        },
        SizeSnapshot {
            name: "chess_mux.sil",
        ...
        SizeSnapshot {
            ...
            expected_bytecode_len: 2543,
            expected_sigscript_len: 9459,
            expected_instruction_count: 1904,
            expected_charged_op_count: 1222,
        },
        SizeSnapshot {
            name: "chess_pawn.sil",
