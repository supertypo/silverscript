...
fn size_snapshots() -> Vec<SizeSnapshot> {
    vec![
        ...
        SizeSnapshot {
            ...
            expected_bytecode_len: 2855,
            expected_sigscript_len: 7623,
            expected_instruction_count: 2037,
            expected_charged_op_count: 1328,
        },
        SizeSnapshot {
            name: "chess_mux.sil",
        ...
        SizeSnapshot {
            ...
            expected_bytecode_len: 2375,
            expected_sigscript_len: 8769,
            expected_instruction_count: 1780,
            expected_charged_op_count: 1138,
        },
        SizeSnapshot {
            name: "chess_pawn.sil",
