...
fn size_snapshots() -> Vec<SizeSnapshot> {
    vec![
        ...
        SizeSnapshot {
            ...
            expected_bytecode_len: 2762,
            expected_sigscript_len: 7437,
            expected_instruction_count: 1998,
        ...
        SizeSnapshot {
            ...
            expected_bytecode_len: 2249,
            expected_sigscript_len: 8457,
            expected_instruction_count: 1721,
            expected_charged_op_count: 1122,
        },
        SizeSnapshot {
            name: "chess_pawn.sil",
