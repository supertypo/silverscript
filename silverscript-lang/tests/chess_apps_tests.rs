...
fn size_snapshots() -> Vec<SizeSnapshot> {
    vec![
        ...
        SizeSnapshot {
            ...
            expected_bytecode_len: 2539,
            expected_sigscript_len: 6991,
            expected_instruction_count: 1839,
            expected_charged_op_count: 1220,
        },
        SizeSnapshot {
            name: "chess_mux.sil",
        ...
        SizeSnapshot {
            ...
            expected_bytecode_len: 2104,
            expected_sigscript_len: 7866,
            expected_instruction_count: 1614,
            expected_charged_op_count: 1050,
        },
        SizeSnapshot {
            name: "chess_pawn.sil",
